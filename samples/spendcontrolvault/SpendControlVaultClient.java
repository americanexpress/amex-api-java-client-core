...
public class SpendControlVaultClient {

	 private static final String CLIENT_ID = "YOUR CLIENT ID";
	 private static final String CLIENT_SECRET = "YOUR CLIENT SECRET_KEY";
	 private static final String SPEND_CONTROL_RESOURCE_URL = "https://api.qasb.americanexpress.com/payments/digital/v1/token/spend_controls";
	 private static final MediaType JSON_MEDIA_TYPE = MediaType.parse("application/json; charset=utf-8");
	 
    public String createSpendControl(String acknowledgementPayload) throws IOException {
    	Properties properties = new Properties();
    	properties.put("CLIENT_KEY", CLIENT_ID);
    	properties.put("CLIENT_SECRET", CLIENT_SECRET);
        properties.put("SPEND_CONTROL_RESOURCE_URL", SPEND_CONTROL_RESOURCE_URL);
        ...
        String url = configurationProvider.getValue("SPEND_CONTROL_RESOURCE_URL");
